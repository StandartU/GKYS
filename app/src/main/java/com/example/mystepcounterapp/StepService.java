package com.example.mystepcounterapp;
...
public class StepService extends Service implements SensorEventListener {
    ...
    private static final float VALLEY_THRESHOLD = 9.6f;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        switch (event.sensor.getType()) {
            case Sensor.TYPE_ACCELEROMETER:
                ...
                Log.v(TAG, String.format(Locale.US, "Sensor Data | Accel Raw: %.2f, Smoothed: %.2f | Gyro: %.2f",
                        magnitude, smoothedMagnitude, lastGyroMagnitude));
    ...
    private void detectStep(float smoothedMagnitude, long currentTimestampNs) {
        ...
        } // Конец else (была фаза VALLEY)
    } // Конец метода detectStep
